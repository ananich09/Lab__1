    ...
    void Draw(Shader& shader, glm::mat4 transform_x1, glm::mat4 transform_x2, glm::mat4 transform_x3) {
        for (unsigned int i = 0; i < meshes.size(); i++) {
            ...
            case 3: {
                ...
                glm::mat4 minusTranslate2_x3 = glm::translate(glm::mat4(1.0), glm::vec3(0.0, -2.2, 0.0));
                glm::mat4 Translate2_x3 = glm::translate(glm::mat4(1.0), glm::vec3(0.0, 2.2, 0.0));

                glm::mat4 result2 = transform_x1* Translate2_x3 * transform_x2 * minusTranslate2_x3 * Translate_x3 * transform_x3 * minusTranslate_x3;
